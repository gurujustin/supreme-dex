        ...
        {stakingInfo.stakedAmount.greaterThan('0') ? (
          <Stats>
            ...
            <Text fontSize={28} fontWeight={500} lineHeight="47px" color="text1">
              {numeral(Number(stakingInfo.stakedAmount.toExact())?.toFixed(2)).format('0.00a')} SUPREME
            </Text>
          </Stats>
        ) : (
          <Stats>
            ...
            <Text fontSize={28} fontWeight={500} lineHeight="47px" color="text1">
              {numeral(Number(stakingInfo.totalStakedInPng.toExact())?.toFixed(2)).format('0.00a')} SUPREME
            </Text>
          </Stats>
        )}
        <Stats>
