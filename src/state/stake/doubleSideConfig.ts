...
export const DOUBLE_SIDE_STAKING: { [key: string]: DoubleSideStaking } = {
  ...
  WAVAX_PNG_V0: {
    tokens: [WAVAX[ChainId.AVALANCHE], SUPREME[ChainId.AVALANCHE]],
  ...
  PNG_WETHe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], WETHe[ChainId.AVALANCHE]],
  ...
  PNG_USDTe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], USDTe[ChainId.AVALANCHE]],
  ...
  PNG_WBTCe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], WBTCe[ChainId.AVALANCHE]],
  ...
  PNG_LINKe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], LINKe[ChainId.AVALANCHE]],
  ...
  PNG_DAIe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], DAIe[ChainId.AVALANCHE]],
  ...
  PNG_UNIe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], UNIe[ChainId.AVALANCHE]],
  ...
  PNG_SUSHIe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], SUSHIe[ChainId.AVALANCHE]],
  ...
  PNG_AAVEe_V1: {
    tokens: [SUPREME[ChainId.AVALANCHE], AAVEe[ChainId.AVALANCHE]],
  ...
  WAVAX_USD_V2: {
    tokens: [WAVAX[ChainId.AVALANCHE], USD[ChainId.AVALANCHE]],
    stakingRewardAddress: MINICHEF_ADDRESS,
    version: 2
  },
  WAVAX_WBTCe_V2: {
  ...
  WAVAX_BUSD_V2: {
    tokens: [WAVAX[ChainId.AVALANCHE], BUSD[ChainId.AVALANCHE]],
    stakingRewardAddress: MINICHEF_ADDRESS,
    version: 2
  },
  WAVAX_LINKe_V2: {
  ...
  WAVAX_MKRe_V2: {
    tokens: [WAVAX[ChainId.AVALANCHE], MKRe[ChainId.AVALANCHE]],
    stakingRewardAddress: MINICHEF_ADDRESS,
    version: 2
  },
  WAVAX_FRAX_V2: {
  ...
  WAVAX_1INCH_V2: {
    tokens: [WAVAX[ChainId.AVALANCHE], INCH[ChainId.AVALANCHE]],
    stakingRewardAddress: MINICHEF_ADDRESS,
    version: 2
  },
}
