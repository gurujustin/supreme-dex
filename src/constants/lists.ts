...
export const AVAX_BRIDGE_LIST = 'http://localhost:3000/tokens.json'

export const DEFAULT_TOKEN_LISTS_SELECTED: string[] = [AVAX_BRIDGE_LIST, DEFI_TOKEN_LIST, STABLECOIN_TOKEN_LIST]
