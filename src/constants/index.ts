...
export const LANDING_PAGE = 'https://supreme.money/'
...
export const MINICHEF_ADDRESS = '0xDeA0ddBc86F6268075e826EFBB744A4A398c65b9'
...
export const BUSD: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 6, 'USDC', 'USD Coin'),
  [ChainId.AVALANCHE]: new Token(ChainId.AVALANCHE, '0x19860ccb0a68fd4213ab9d8266f7bbf05a8dde98', 6, 'BUSD.e', 'Binance USD')
}

export const INCH: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'HERMES', 'HERMES'),
  [ChainId.AVALANCHE]: new Token(
    ChainId.AVALANCHE,
...
export const MKRe: { [chainId in ChainId]: Token } = {
  [ChainId.FUJI]: new Token(ChainId.FUJI, ZERO_ADDRESS, 18, 'HSHARES', 'HERMES Shares'),
  [ChainId.AVALANCHE]: new Token(
    ChainId.AVALANCHE,
