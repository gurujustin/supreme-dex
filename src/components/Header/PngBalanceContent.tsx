...
import tokenLogo from '../../assets/images/supreme.png'
...
const ModalUpper = styled(DataCard)`
  ...
  background: radial-gradient(76.02% 75.41% at 1.84% 0%,#975b9d 0%,#1f2a77 100%);
  padding: 0.5rem;
`
...
export default function PngBalanceContent({ setShowPngBalanceModal }: { setShowPngBalanceModal: any }) {
  ...
  const png = chainId ? SUPREME[chainId] : undefined
